...
public class Circle{
    ...
    /**
     * function to find the area of a circle with its diameter
     */
    ...
    public void shrink(int times, int minArea) {
        float areaMomento = area((float)diameter); 
        
        while (areaMomento > minArea && diameter > 1) {
            diameter = diameter / times;
    
            changeSize((int)diameter);
            
            areaMomento = area((float)diameter);
        }
    }
    
    /**
     * allows you to create a circle with a specific area.
     */
    ...
    /**
     * Allows you to place the circle exactly where you want on the screen.
     */
